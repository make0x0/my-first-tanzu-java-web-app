...
```json
{
  "projectName" : "my-first-tanzu-java-web-app",
  "repositoryPrefix" : "997135046188.dkr.ecr.us-east-1.amazonaws.com"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->my-first-tanzu-java-...(truncated)]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.merge.transformations[0].sources[1].<combo>.transformations[2] (ReplaceText)
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->997135046188.dkr.ecr...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: tanzu-java-web-app->: my-first-tanzu-jav...(truncated)]
